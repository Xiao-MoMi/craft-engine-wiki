...
![3D armor created with CraftEngine Config Helper](/img/3darmor.png)

Use the [CraftEngine Config Helper](https://cech.gtemc.cn/) to convert Blockbench `.bbmodel` files into CraftEngine-compatible 3D armor resource packs.
