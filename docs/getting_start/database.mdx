...
storage:
  type: mysql
  # Create the database and account first; allow schema changes and data access
...
storage:
  ...
  database: minecraft # Database for plugin data
  username: '' # Authentication username; leave empty if authentication is disabled
  password: '' # Authentication password
  auth_source: admin # Database containing the authentication user
  max_pool_size: 10 # Maximum connections; minimum 1
  # Optional full URL; overrides host, port, database, auth_source and max_pool_size
  # Supports mongodb:// and mongodb+srv://; include a database name
  # Example: mongodb://localhost:27017/minecraft?authSource=admin&maxPoolSize=10
